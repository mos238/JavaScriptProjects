let spaceship = {
    passengers: [{name: 'Space Dog'}], //Array of objects
    /* Q2.
...
Make at least one passenger object in the array that has at least one key-value pair on it. */
    ...
    crew: {
      captain: {
        ...
        'favorite foods': ["cookies", "cakes", "candy", "spinach"], //Array (had to write this line of code , part of Q1)
        encourageTeam() {
...
(the element in the 0th index of her 'favorite foods' array) to it. Make sure to use bracket and dot notation 
to get the value of the food through nested access 
(don’t just copy the value into the variable!) */
  
  let capFave = spaceship.crew.captain['favorite foods'][0];
  console.log(capFave);
  /* Q3.Create a variable firstPassenger and assign the first passenger as 
  its value (the element in the 0th index of the spaceship.passengers array you just made).
