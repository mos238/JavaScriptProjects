...
/* Explanation:
The function takes in three parameters: name (string), breed (string), and weight (number).
It returns an object where each of these parameters becomes a key, and their corresponding values are set based on the 
